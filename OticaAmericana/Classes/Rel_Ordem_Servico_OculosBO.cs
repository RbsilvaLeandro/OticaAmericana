...
{
    class Rel_Ordem_Servico_OculosBO
    {
        private string data;
        ...
        private string codigoOculos;
        public string codOculos
        {
        ...
        {
            //Rel_Ordem_Servico_oculosVO ordemservicoVO = new Rel_Ordem_Servico_oculosVO();
            Rel_Ordem_Servico_OculosDAO ordemservicoDAO = new Rel_Ordem_Servico_OculosDAO();
            DataSet novoDataset = null;
            novoDataset = ordemservicoDAO.criaOrdemServico(txt_codOculos);
